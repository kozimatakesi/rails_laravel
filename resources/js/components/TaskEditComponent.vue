             ...
             <div class="col-sm-6">
                 <form v-on:submit.prevent="submit">
                     ...
                     <div class="form-group row">
                         ...
                         <input type="text" class="col-sm-9 form-control" readonly id="title" :value="oldTaskTitle">
                         <label for="title" class="col-sm-3 col-form-label">Update title</label>
                         <input type="text" class="col-sm-9 form-control" id="title" v-model="task.title">
                     </div>
                     <div class="form-group row">
                         <label for="content" class="col-sm-3 col-form-label">Content</label>
                         <input type="text" class="col-sm-9 form-control" readonly id="content" :value="oldTaskContent">
                     ...
                     <div class="form-group row">
                         ...
                         <input type="text" class="col-sm-9 form-control" readonly id="person-in-change" :value="oldTaskPersonInChange">
